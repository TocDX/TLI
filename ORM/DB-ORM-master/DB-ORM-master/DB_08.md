...
print('id : ', direc.id)
print('name :',direc.name)
print('debut :',direc.debut)
print('country : ',direc.country)
```
...
```python
movie = Movie.objects.order_by('opening_date')[:1]
for i in movie:
    print(Director.objects.get(id = i.director_id).name,Genre.objects.get(id = i.genre_id).title,i.title,i.opening_date,i.running_time,i.screening)
```
...
movie = Movie.objects.order_by('opening_date')
for i in movie:
    if Director.objects.get(id = i.director_id).name == '봉준호':
        print(Director.objects.get(id = i.director_id).name,Genre.objects.get(id = i.genre_id).title,i.title,i.opening_date,i.running_time,i.screening)
```
...
```python
movie = Movie.objects.order_by('running_time')

for i in movie:
    if i.running_time > 119:
        print(Director.objects.get(id = i.director_id).name,Genre.objects.get(id = i.genre_id).title,i.title,i.opening_date,i.running_time,i.screening)
```
...
```python
start_ = datetime.date(2022,1,1)
movie = Movie.objects.order_by('opening_date')
for i in movie:
    if i.opening_date > start_:
        print(Director.objects.get(id = i.director_id).name,Genre.objects.get(id = i.genre_id).title,i.title,i.opening_date,i.running_time,i.screening)
```
